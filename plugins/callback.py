        ...
        if not n:
            ...
            if a['traducao']:
                keyboard = InlineKeyboardMarkup(inline_keyboard=[
                    ...
                    [InlineKeyboardButton(text=t('port'), callback_data=f'_-{user}|{hash}')]
                ])
            else:
                keyboard = InlineKeyboardMarkup(inline_keyboard=[
                    [InlineKeyboardButton(text=t('text'), callback_data=f'+{user}|{hash}')]
...
async def tetr(c, m, t):
    ...
    if m.from_user.id == int(user) or m.from_user.id in sudos:
        ...
        if not n:
            ...
            keyboard = InlineKeyboardMarkup(inline_keyboard=[
                [InlineKeyboardButton(text=t('text'), callback_data=f'-{user}|{hash}')] +
                [InlineKeyboardButton(text=t('original'), callback_data=f'_+{user}|{hash}')]
            ])
            await m.edit_message_text(
        ...
        if not n:
            ...
            if a['traducao']:
                keyboard = InlineKeyboardMarkup(inline_keyboard=[
                    ...
                    [InlineKeyboardButton(text=t('por'), callback_data=f'-{user}|{hash}')]
                ])
            else:
                keyboard = InlineKeyboardMarkup(inline_keyboard=[
                    [InlineKeyboardButton(text=t('tgph'), callback_data=f'_+{user}|{hash}')]
...
async def tr(c, m, t):
    ...
    if m.from_user.id == int(user) or m.from_user.id in sudos:
        ...
        if not n:
            ...
            keyboard = InlineKeyboardMarkup(inline_keyboard=[
                [InlineKeyboardButton(text=t('tgph'), callback_data=f'_-{user}|{hash}')] +
                [InlineKeyboardButton(text=t('original'), callback_data=f'+{user}|{hash}')]
            ])
            await m.edit_message_text(
...
async def settings(c, m, t):
    ...
    await m.edit_message_text(
        t('settings_txt'), reply_markup=keyboard)
...
async def theme(c, m, t):
    ...
    await m.edit_message_text(
        t('np_settings_txt'), reply_markup=keyboard)
...
async def pattern(c, m, t):
    ...
    await m.edit_message_text(
        t('pattern_settings_text'), reply_markup=keyboard)
