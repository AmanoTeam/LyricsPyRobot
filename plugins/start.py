...
async def help(c, m):
    await m.reply_text('Este bot exibe letra de músicas de acordo com sua pesquisa, utilizando o musixmatch.com.\n\n'
                       'Você pode pesquisar atravez do modo inline (@lyricspyrobot <música>), ou até mesmo ver a '
                       'letra da música que está tocando em seu Spotify atravez do spoti (necessita login) :D\n\n '
