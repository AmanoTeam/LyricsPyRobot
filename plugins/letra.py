...
async def letra(c, m):
    ...
    await m.reply_text('[{} - {}]({})\n{}'.format(a["musica"], a["autor"], a['link'], a['letra'])[:4096].encode("latin-1", 'ignbackslashreplaceore').decode("unicode_escape"), reply_markup=keyboard, disable_web_page_preview=True)
